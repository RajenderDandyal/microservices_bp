...
public class InvoiceService {
    ...
    public List<InvoiceDTO> getInvoiceList(String userId, HttpServletRequest request) {
        ...
        if(StringUtils.isEmpty(userId)) {
            ...
            throw new InvoiceException(HttpStatus.BAD_REQUEST.value(), "Bad request", request.getPathInfo(), List.of("userId is missing in request."));
        }
        ...
        if(invoices.isEmpty()){
            ...
            throw new InvoiceException(HttpStatus.BAD_REQUEST.value(), "Bad request", request.getPathInfo(), List.of("userId not found in db."));
        }
